...
function Group({
  ...
  return (
    <section className="flex w-full shrink-0 flex-col items-start gap-2 overflow-clip px-6">
  ...
  return (
    <MobileScreen className="pb-0">
      ...
      <div className="flex w-full shrink-0 items-start gap-3 overflow-clip border-t border-border bg-card px-6 py-3">
        <NeutralButton className="w-30 shrink-0" href="/advisor/profile">
          {c("cancel")}
        </NeutralButton>
        <PrimaryButton className="min-w-px flex-1" href="/advisor/profile">
          {t("save")}
        </PrimaryButton>
      </div>
    </MobileScreen>
