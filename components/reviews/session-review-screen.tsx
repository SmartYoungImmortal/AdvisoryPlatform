 ...
 *
 * Figma "Desktop / Review - Submit failed (Light)" (1787:26266) gathers the
 * whole screen into a 640px panel under the app's nav: the frame has no back
 * bar and no head band, because the hero is the heading and the only way on
 * from here is one of the two actions at the bottom.
 */
